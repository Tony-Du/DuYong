...
import com.iflytek.gnome.analysis.mapreduce.MRVideoPlayReport;
 ...
 *
 */
public class VideoPlayReportMain extends ReportOozieMain implements Tool {

    private static final Log LOG = LogFactory.getLog(BaseTable4VideoMain.class);

    public static final String DIRECTORY_OUT = ReportLocationConstants.VIDEO_PLAY;

    private String reportName = "VideoPlayReportMain";
    ...
    public void process(Iterable<Path> inputs, Date startDate) throws Exception {
        ...
        job.setMapperClass(MRVideoPlayReport.M1.class);
        job.setReducerClass(MRVideoPlayReport.R1.class);
        ...
        //导入数据到数据库
        super.setTableName(ResUtil.getJdbcValue("db_video_play_table_name"));
    ...
    public static void main(String[] args) throws Exception {
        int res = OozieToolRunner.run(null, new VideoPlayReportMain(), args);
        System.exit(res);
