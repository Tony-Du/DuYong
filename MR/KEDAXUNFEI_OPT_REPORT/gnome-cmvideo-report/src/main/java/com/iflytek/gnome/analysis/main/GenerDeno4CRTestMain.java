...
import com.iflytek.gnome.analysis.mapreduce.MRGenerDenoTest;
import com.iflytek.gnome.analysis.source.ComplainCollectSource;
import com.iflytek.gnome.analysis.source.DenoIncomeCollectSourceTest;
...
public class GenerDeno4CRTestMain extends OozieMain implements Tool{
	
	public static final Log LOG = LogFactory.getLog(GenerDeno4CRTestMain.class);
    ...
    public int run(String[] args) throws Exception {
        ...
        List<Path> inputs = DenoIncomeCollectSourceTest.get().getInputs(startDate, userName, getConf(), reportName);
...
//		conf.setInt("mapred.reduce.tasks", 1);
        ...
        job.setJobName(GenerDeno4CRTestMain.class.getSimpleName() + ":" + GnomeDateFormat.FORMAT_TILL_DATE.format(startDate));
//        job.setInputFormatClass();
        job.setMapperClass(MRGenerDenoTest.M1.class);
        job.setReducerClass(MRGenerDenoTest.R1.class);
...
//                	job.addCacheFile(fss[0].getPath().toUri());
        ...
        /*** 设置mapReduce输出数据路径 ***/
		Path tmpOutput = new Path(ConstantsUtils.getTmpSegmentDir(new Path(GenerDeno4CRTestMain.base)), reportName + tmpChildDir);
...
//        job2.setJobName(GenerDeno4CRTestMain.class.getSimpleName() + "_2" + ":" + GnomeDateFormat.FORMAT_TILL_DATE.format(startDate));
////        job2.setInputFormatClass();
//        job2.setMapperClass(MRGenerDenoTest.M2.class);
//        job2.setReducerClass(MRGenerDenoTest.R2.class);
//        
...
//		
//		Path tmpOutput2 = new Path(ConstantsUtils.getTmpSegmentDir(new Path(GenerDeno4CRTestMain.base)), reportName + "2_" + tmpChildDir);
...
//		
    ...
    {
        int res = OozieToolRunner.run(null, new GenerDeno4CRTestMain(), args);
        System.exit(res);
    }
