...
//import org.apache.mahout.clustering.conversion;
 ...
 *
 */
public final class InputDriverFilterKey {

  private static final Logger log = LoggerFactory.getLogger(InputDriverFilterKey.class);
  
  private InputDriverFilterKey() {
  }
  ...
  public static void runJob(Path input, Path output, String vectorClassName)
    ...
    job.setMapperClass(InputMapperFilterKey.class);   
    job.setNumReduceTasks(0);
    job.setJarByClass(InputDriverFilterKey.class);
