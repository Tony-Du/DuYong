...
import com.mganaly.cdmp.mapred.td_oms_program_d_mapper;

public class td_oms_program_d_tool extends MRCmdTool {
	...
	protected int confJobParas (String[] args) throws IOException {
		...
		_mr_job.setMapperClass(td_oms_program_d_mapper.class);
