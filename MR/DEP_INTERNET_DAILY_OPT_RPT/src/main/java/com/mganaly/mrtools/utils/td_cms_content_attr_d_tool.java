...
import com.mganaly.cdmp.data.tbl.td_cms_content_attr_d;
...
public class td_cms_content_attr_d_tool extends MRCmdTool {
	
	private static final Log _LOG = LogFactory.getLog(td_cms_content_attr_d_tool.class);
	 ...
	 *
	 */
	public static class td_cms_content_attr_d_mapper extends cdmp_base_mapper {
		
		
		@Override
		protected cdmp_base_tbl getDataType() {
			if (null == _dataType) {
				_dataType = new td_cms_content_attr_d();
			}
			return _dataType;
		}
	...
	protected int confJobParas (String[] args) throws IOException {
		...
		_mr_job.setMapperClass(td_cms_content_attr_d_mapper.class);
...
} //class td_cms_content_attr_d_tool
