...
/*+------------------------------------------------------
-- 同步到oracle的目标表
drop table cpa_event_params_last30_daily;

create table cdmp_dmt.cpa_event_params_last30_daily
(
   src_file_day         char(8),
...
create index idx_cpa_event_params_last30_d on cdmp_dmt.cpa_event_params_last30_daily
(
   src_file_day,
   app_channel_id,
   event_name,
