...
set mapreduce.job.name=rptdata.fact_ugc_order_usernum_weekly${SRC_FILE_DAY};

set hive.groupby.skewindata=false;
set hive.optimize.skewjoin=true;
set hive.merge.mapredfiles = true;

insert overwrite table rptdata.fact_ugc_order_user_num_weekly partition (src_file_day='${SRC_FILE_DAY}')
select 
...
from ( 
    ...
    from (
            select 
                ...
                case when (a.period_unit = 'MONTH' and a.order_status = 5 and a.good s_type not in ('MIGU_MOVIE_CARD','MOVIE_CARD_DELAY','MIGU_LIVE')) then 'Y' else 'N' end as add_month_order_user_flag,
                ...
                --case when (a.period_unit = 'MONTH' and a.goods_type not in ('MIGU_MOVIE_CARD','MOVIE_CARD_DELAY','MIGU_LIVE') and a.main = 0 and a.pay_chn_type in (50,58,59,302,304,306) and a.order_status = 5) then 'Y' else 'N' end  as idea_pay_user_flag,
            ...
            where a.src_file_day>='${SRC_FILE_DAY}' and a.src_file_day<from_unixtime(unix_timestamp('${SRC_FILE_DAY}','yyyyMMdd')+60*60*24*7,'yyyyMMdd')
            ...
            select 
                ...
                'N' as active_visit_user_flag
            from rptdata.fact_ugc_tpp_in_order_detail_daily a
            left outer join rptdata.dim_server h
            on a.sub_busi_id = h.sub_busi_id --and h.dw_delete_flag = 'N'
            left outer join rptdata.dim_dept_term_prod b --<部门-终端产品维表> b
            on a.term_prod_id = b.term_prod_id  --and b.dw_delete_flag = 'N'
    ...
    group by dept_id,term_prod_id,term_video_type_id,term_video_soft_id,term_prod_type_id,term_version_id,term_os_type_id,busi_id,
        sub_busi_id,net_type_id,product_id,cp_id,content_id,content_type,broadcast_type_id,user_type_id,province_id,city_id,phone_province_id, phone_city_id,company_id,
        chn_id,chn_attr_1_id,chn_attr_2_id,chn_attr_3_id,chn_attr_4_id, chn_type, con_class_1_name, copyright_type, busi_type_id, program_id, user_id
    grouping sets (
                -- 核心
                (dept_id, user_id), 
...
group by dept_id,term_prod_id,term_video_type_id,term_video_soft_id,term_prod_type_id,term_version_id,term_os_type_id,busi_id,
        sub_busi_id,net_type_id,product_id,cp_id,content_id,content_type,broadcast_type_id,user_type_id,province_id,city_id,phone_province_id, phone_city_id,company_id,
        chn_id,chn_attr_1_id,chn_attr_2_id,chn_attr_3_id,chn_attr_4_id, chn_type, con_class_1_name, copyright_type, busi_type_id, program_id, dim_group_id
;
