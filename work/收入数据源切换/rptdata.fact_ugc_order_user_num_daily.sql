...
select 
    ...
    cast(bb.dim_group_id as int) & 536870911 as dim_group_id
from ( 
	select 
	...
	from (
			select 
				...
				case when a.src_file_day='${SRC_FILE_DAY}' and (a.period_unit = 'MONTH' and a.pay_chn_type not in (50,58,59,302,304,306) and a.order_status = 5 and a.goods_type not in ('MIGU_MOVIE_CARD','MOVIE_CARD_DELAY','MIGU_LIVE')) then 'Y' else 'N' end as third_add_month_order_user_flag,
				case when (a.period_unit = 'MONTH' and a.pay_chn_type not in (50,58,59,302,304,306) and a.order_status = 5 and a.goods_type not in ('MIGU_MOVIE_CARD','MOVIE_CARD_DELAY','MIGU_LIVE')) then 'Y' else 'N' end as mon_third_add_month_order_user_flag,
				case when a.src_file_day='${SRC_FILE_DAY}' and (a.period_unit = 'HOUR' and a.pay_chn_type not in (50,58,59,302,304,306) and a.order_status = 5 and  a.goods_type not in ('MIGU_MOVIE_CARD','MOVIE_CARD_DELAY','MIGU_LIVE')) then 'Y' else 'N' end as third_add_time_order_user_flag,
				case when (a.period_unit = 'HOUR' and a.pay_chn_type not in (50,58,59,302,304,306) and a.order_status = 5 and  a.goods_type not in ('MIGU_MOVIE_CARD','MOVIE_CARD_DELAY','MIGU_LIVE')) then 'Y' else 'N' end as mon_third_add_time_order_user_flag,
				case when a.src_file_day='${SRC_FILE_DAY}' and (a.pay_chn_type not in (50,58,59,302,304,306) and a.order_status = 5 and a.goods_type not in ('MIGU_MOVIE_CARD','MOVIE_CARD_DELAY','MIGU_LIVE')) then 'Y' else 'N' end as third_prepay_user_flag,
				case when (a.pay_chn_type not in (50,58,59,302,304,306) and a.order_status = 5 and a.goods_type not in ('MIGU_MOVIE_CARD','MOVIE_CARD_DELAY','MIGU_LIVE')) then 'Y' else 'N' end as mon_third_prepay_user_flag,
				...
				case when a.src_file_day='${SRC_FILE_DAY}' and (a.period_unit = 'MONTH' and a.order_status = 5 and a.goods_type not in ('MIGU_MOVIE_CARD','MOVIE_CARD_DELAY','MIGU_LIVE')) then 'Y' else 'N' end as add_month_order_user_flag,
				case when (a.period_unit = 'MONTH' and a.order_status = 5 and a.goods_type not in ('MIGU_MOVIE_CARD','MOVIE_CARD_DELAY','MIGU_LIVE')) then 'Y' else 'N' end as mon_add_month_order_user_flag,
				case when a.src_file_day='${SRC_FILE_DAY}' and (a.period_unit = 'HOUR' and a.order_status = 5 and a.goods_type not in ('MIGU_MOVIE_CARD','MOVIE_CARD_DELAY','MIGU_LIVE')) then 'Y' else 'N' end as add_time_order_user_flag,
				case when (a.period_unit = 'HOUR' and a.order_status = 5 and a.goods_type not in ('MIGU_MOVIE_CARD','MOVIE_CARD_DELAY','MIGU_LIVE')) then 'Y' else 'N' end as mon_add_time_order_user_flag,
	      ...
	      case when (a.src_file_day='${SRC_FILE_DAY}' and a.goods_type not in ('MIGU_MOVIE_CARD','MOVIE_CARD_DELAY','MIGU_LIVE') and a.main = 0 and a.pay_chn_type in (50,58,59,302,304,306) and a.order_status = 5) then 'Y' else 'N' end  as idea_pay_user_flag,
      ...
      where a.src_file_day='${SRC_FILE_END_MONTH_DAY}'  ----统计上月底快照
        ...
        '-998' as copyright_type,
				...
				'N' as add_time_order_user_flag,
				'N' as mon_add_time_order_user_flag,
				case when (a.src_file_day='${SRC_FILE_DAY}' and a.chrgprod_price > 0 and a.order_status <> '4' and a.sub_status is null) then 'Y' else 'N' end as month_in_order_user_flag,
	     ...
	     'N' as mon_idea_pay_user_flag,
			...
			select 
				...
				'N' as third_month_share_pay_user_flag,
				'N' as mon_third_month_share_pay_user_flag,
				case when (a.src_file_day='${SRC_FILE_DAY}') then 'Y' else 'N' end as third_pay_user_flag,
				'Y' as mon_third_pay_user_flag,
				'N' as add_month_order_user_flag,
				'N' as mon_add_month_order_user_flag,
				'N' as add_time_order_user_flag,
				'N' as mon_add_time_order_user_flag,
				case when (a.src_file_day='${SRC_FILE_DAY}') then 'Y' else 'N' end as month_in_order_user_flag,
				'Y' as mon_month_in_order_user_flag,
				--'N' as pay_user_flag,
				--'N' as mon_pay_user_flag,
				'N' as boss_pay_user_flag,
				'N' as mon_boss_pay_user_flag,
          ...
          'N' as mon_active_visit_user_flag
	        ...
	        'N' as idea_pay_user_flag,
	       'N' as mon_idea_pay_user_flag,
         case when (a.src_file_day='${SRC_FILE_DAY}') then 'Y' else 'N' end as active_visit_user_flag,
         'Y' as mon_active_visit_user_flag
	...
	group by dept_id,term_prod_id,term_video_type_id,term_video_soft_id,term_prod_type_id,term_version_id,term_os_type_id,busi_id,
        ...
        chn_id,chn_attr_1_id,chn_attr_2_id,chn_attr_3_id,chn_attr_4_id, chn_type, con_class_1_name, copyright_type,user_id
	grouping sets (
									-- 核心
									(dept_id, user_id), 
									...
									(dept_id, busi_id, company_id, chn_id, user_id),
									...
									(dept_id, busi_id, phone_province_id, company_id, user_type_id, chn_id, user_id),
									...
									-- 客服
									(busi_id, sub_busi_id, user_id),
									--(phone_province_id, user_id),
									--(phone_province_id, phone_city_id, user_id),
									--(busi_id, sub_busi_id, phone_province_id, phone_city_id, user_id),
									--(busi_id, sub_busi_id, phone_province_id, user_id),
...
group by dept_id,term_prod_id,term_video_type_id,term_video_soft_id,term_prod_type_id,term_version_id,term_os_type_id,busi_id,
        sub_busi_id,net_type_id,product_id,cp_id,content_id,content_type,broadcast_type_id,user_type_id,province_id,city_id,phone_province_id, phone_city_id,company_id,
        chn_id,chn_attr_1_id,chn_attr_2_id,chn_attr_3_id,chn_attr_4_id, chn_type, con_class_1_name, copyright_type,dim_group_id
;