...
alter table cdmpview.tmp_dy_05_assess_1_add_revenue add partition (src_file_month = '201704');
alter table cdmpview.tmp_dy_05_assess_1_add_revenue add partition (src_file_month = '201705');

insert overwrite table cdmpview.tmp_dy_05_assess_1_add_revenue partition (src_file_month = '201704')
select * from accu_add_revenue_May where statis_month = '201704';
