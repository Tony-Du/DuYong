alter table rptdata.cdmp_rpt_cnt_weekly rename to bkp.cdmp_rpt_cnt_weekly_20170525;
drop table rptdata.cdmp_rpt_cnt_weekly;
alter table temp.cdmp_rpt_cnt_weekly_20170525 rename to rptdata.cdmp_rpt_cnt_weekly;

CREATE  TABLE rptdata.cdmp_rpt_cnt_weekly (
  dept_id                           string,
  term_prod_id                      string,
...
insert overwrite table rptdata.cdmp_rpt_cnt_weekly partition (src_file_day)
select 
    dept_id,
    term_prod_id,
    term_video_type_id,
    ...
    dim_group_id,
    src_file_day
from bkp.cdmp_rpt_cnt_weekly_20170525 t ;