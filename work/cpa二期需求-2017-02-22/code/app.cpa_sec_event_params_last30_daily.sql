...
drop table if exists app.cpa_sec_event_params_last30_daily;

create table app.cpa_sec_event_params_last30_daily(
product_key    string,
product_name   string,
app_ver_code   string,
...
set mapreduce.job.name=app.cpa_sec_event_params_last30_daily_${SRC_FILE_DAY};
...
insert overwrite table app.cpa_sec_event_params_last30_daily partition (src_file_day = '${SRC_FILE_DAY}')
